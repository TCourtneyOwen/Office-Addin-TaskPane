...
hosts.forEach(function (host) {
    ...
    describe(`Test ${host} Task Pane Project`, function () {
        before(`Setup test environment and sideload ${host}`, async function () {
            ...
            await startDebugging(manifestPath, {appType: AppType.Desktop, app: toOfficeApp(host), devServerCommandLine:devServerCmd, devServerPort:devServerPort, enableDebugging:false});
        }),
